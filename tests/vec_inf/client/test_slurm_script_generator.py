...
class TestSlurmScriptGenerator:
    ...
    def basic_params(self):
        ...
        return {
            ...
            "model_weights_parent_dir": "/path/to/model_wieght",
            "src_dir": "/path/to/src",
    ...
    def test_init_single_node(self, basic_params):
        ...
        assert generator.model_weights_path == "/path/to/model_wieght/test-model"
    ...
    def test_generate_launch_cmd_venv(self, basic_params):
        ...
        assert "vllm serve /path/to/model_wieght/test-model" in launch_cmd
    ...
    def test_generate_launch_cmd_singularity(self, singularity_params):
        ...
        assert "--bind /path/to/model_wieght/test-model" in launch_cmd
